...
function get20s(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    if (bornCondition && deathCondition) {
      deathIn20s.push(artist);
    }
  }
...
let newArtist = {
  ...
  bio:
    "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestiae corrupti quis culpa suscipit excepturi blanditiis facere tempore sint non iusto?",
};
